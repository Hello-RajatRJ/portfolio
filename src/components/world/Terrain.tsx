...
export const Terrain: React.FC = () => {
  // Generate terrain geometry with hills on the edges
  const geometry = useMemo(() => {
    const geo = new PlaneGeometry(100, 100, 64, 64);
