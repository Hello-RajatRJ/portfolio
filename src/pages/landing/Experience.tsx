  ...
  return (
    <section id="experience" ref={ref} className="py-20 sm:py-32 bg-dark-800 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 w-80 h-80 bg-primary-500/5 rounded-full blur-3xl pointer-events-none"
      />
            ...
            >
              ...
              <div className="flex-1 md:max-w-[calc(50%-2rem)]">
                <motion.div
                  whileHover={{
                    scale: 1.03,
                    y: -6,
                    boxShadow: `0 20px 50px ${exp.color}20`,
                    borderColor: exp.color,
                    transition: { type: 'spring', stiffness: 300, damping: 15 },
                  }}
                  className="bg-white border border-gray-200 hover:border-primary-300 rounded-2xl p-6 transition-colors duration-300 shadow-sm group cursor-default"
              ...
              <div className="hidden md:flex items-start justify-center w-16 shrink-0">
                <motion.div
                  ...
                  className="w-4 h-4 rounded-full mt-6 border-2 border-white pulse-glow-node"
