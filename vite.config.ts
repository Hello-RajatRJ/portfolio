...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Rajat Ambedkar | Senior Full-Stack Developer Portfolio',
        short_name: 'Rajat RJ',
        description: 'Official Portfolio & Resume Builder of Rajat Ambedkar - Senior Full-Stack Developer & UI Architect.',
        theme_color: '#0b0f19',
